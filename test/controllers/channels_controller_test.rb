...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference("Channel.count") do
      post channels_url, params: { channel: { channel: @channel.channel, discussion_id: @channel.discussion_id } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { channel: @channel.channel, discussion_id: @channel.discussion_id } }
